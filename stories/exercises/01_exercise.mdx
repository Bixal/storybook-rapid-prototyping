...
1. Fix images by updating the paths from `/assets/img` → `/img`. <i>This will use the images from the USWDS node package.</i>

1. Add the component to your base template. Our vite config allows us to reference components with a namespace shorthand `@components`.
