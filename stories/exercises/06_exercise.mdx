...
1. Easy, right? Let's add a bit more color to our banner. Let's see what would happen if we brought back our accent color:
   ...
   The banner background color updated, but if you take a close look at the banner link the contrast doesn't look great. If you take a look at the script running in the terminal window you'll notice a bunch of color contrast warnings have popped up.
